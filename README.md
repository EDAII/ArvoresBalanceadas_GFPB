# Exercícios de Arvores Balanceadas Resolvidos no LeetCode

**Número da Lista**: 28<br>
**Conteúdo da Disciplina**: Arvores Balanceadas<br>
...
Este projeto tem como objetivo aprofundar o conhecimento em sobre Arvores Binárias e Algoritmos de balanceamento vistos na disciplina de Estrutura de Dados 2, através da resolução de problemas práticos. Vamos trabalhar com 4 questões do LeetCode para consolidar diferentes técnicas de resolução.
